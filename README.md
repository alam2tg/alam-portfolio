...
- React as a tool allows me to be more organized with my webpages by allowing CSS, HTML, and Javascript to be in a single file. This allows my files to be more organized and generally easier to use (less switching between HTML, CSS, and Javascript pages)
- Dramatically improved CSS skills/fundamentals. Started using :root to declare CSS vars for colors and fonts
- Import method to include components and images in React Pages
- React, ReactDom, and React-Router-Dom tools like UseState to add functionality to each section of my page (divs). 

<br>

## Features

- Carousel Project Selection
- Navbar Navigation
- Downloadable Resume
